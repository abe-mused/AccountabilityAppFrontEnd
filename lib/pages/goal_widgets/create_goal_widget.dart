...
class _CreateGoalWidgetState extends State<CreateGoalWidget> {
  ...
  doCreatePost() {
    ...
    final Future<Map<String, dynamic>> successfulMessage =
        createGoal(int.parse(checkInGoalInput.text.toString()), goalBodyInput.text, widget.communityName, widget.token);
        ...
        showDialog(
            ...
            builder: (context) {
              return AlertDialog(
                ...
                content: const Text("An error occured while attempting to create the goal."),
                actions: [
                  TextButton(
                      onPressed: () {
                        Navigator.pop(context);
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              ElevatedButton(
                onPressed: () async {
                  if (goalBodyInput.text != '' && checkInGoalInput.text != '') {
                    doCreatePost();
                  } else {
                    showDialog(
                        context: context,
