...
import 'package:linear/resetPasswordNewPassword.dart';
import 'main.dart';
        ...
        child: Stack(
          children: [
            const Padding(
              ...
              child: Text("Enter Verification \nCode Sent To \nYour Email",style: TextStyle(color: Colors.white,fontSize: 50,fontWeight: FontWeight.w300),),
            )
            ,         Container(
              ...
              child: Column(
                ...
                children: [
                  const Text("Enter Code",style: TextStyle(fontSize: 45,fontWeight: FontWeight.w400),),
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context,
                              MaterialPageRoute(builder: (context) => const ResetPasswordNewPasswordPage()));
